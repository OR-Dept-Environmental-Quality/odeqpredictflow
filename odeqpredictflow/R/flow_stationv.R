...
#' @export
#' @examples
#' result <- Predict.Mean.Daily.Flow.Station_Vector("UmpNF-078",c("2010-01-01","2011-03-04","2012-12-31"))
#' timeseries <- result[[1]]
#' flows <- timeseries$`PredictedFlow(cfs)`
#' details <- result[[2]]
#'

Predict.Mean.Daily.Flow.Station_Vector <- function(station,date_vector){
